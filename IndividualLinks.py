...
class IndividualLinks(loader.Module):
  ...
  strings_ru = {
    ...
    "list": (
      "<i><b><emoji document_id=5866355487255039002>🚀</emoji>Единого официального списка стран, поддерживающих порнографический контент в Telegram, не существует. Однако многие страны разрешают пользователям просматривать и делиться порнографическим контентом в Telegram. Сюда входят  следующие страны:\<emoji document_id=5215203655946346044>🔞</emoji>Информация может быть неверной, она взята с интернета</i>\n\n- Россия (RU)\n- США (US)\n- Канада (CA)\n- Австралия (AU)\n- Ирландия (IE)\n- Нидерланды (NL)\n- Франция (FR)\n- Великобритания (GB)\n- Испания (ES)\n- Германия (DE)\n- Италия (IT)\n- Швеция (SE)\n- Норвегия (NO)\n- Дания (DK)\n- Япония (JP)</b>"
    ),
  }
