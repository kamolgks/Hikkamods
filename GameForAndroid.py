...
@loader.tds
class GameForAndroidMod(loader.Module):
    ...
    async def bhop_pro(self, *_):
      await self.client.send_message(
        self.chat_id, self.strings("bhop_pro"), file="https://t.me/logimeh/12",
        )
        
    async def bhop_pro_mod(self, *_):
      await self.client.send_message(
        self.chat_id, self.strings("bhop_pro_mod"), file="https://t.me/logimeh/11",
        )
    ...
    async def clash_r(self, *_):
      await self.client.send_message(
        self.chat_id, self.strings("clash_r"), file="https://t.me/logimeh/7",
        )
    ...
    async def subwaysurf_mod(self, *_):
      await self.client.send_message(
        self.chat_id, self.strings("subwaysurf_mod"), file="https://t.me/androeed_games/44187",
        )
        
    async def subwaysurf(self, *_):
      await self.client.send_message(
        self.chat_id, self.strings("subway"), file="https://t.me/androeed_games/44188",
        )
